    ...
    methods:{
        ...
        nextPage() {
            ...
            this.comments = [{
                ...
                user: {uUsername: '钢侠', uAvater: '/static/images/small_logo.png'},
                replys: []
            }]
        },
